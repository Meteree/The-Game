...
quiz_questions = {
    ...
    "start": Question(
        ...
        answer_id=0,
        options=["Ormana gir", "Markete uğra", "Bataklığa sap", "Kale yoluna çık"],
    ...
    "market": Question(
        ...
        answer_id=0,
        options=["Demirciye git", "Şifacıya git", "Tüccara git", "Geri dön"],
    ...
    "demirci": Question(
        ...
        answer_id=0,
        options=["Balta al", "Zırh al", "Mızrak al", "Geri dön"],
    ...
    "sifaci": Question(
        ...
        answer_id=0,
        options=["Şifa iksiri al", "Geri dön"],
    ...
    "tuccar": Question(
        ...
        answer_id=0,
        options=["Ok & yay al", "Kuvvet iksiri al", "Ganimet iksiri al", "Geri dön"],
    ...
    "orman": Question(
        ...
        answer_id=0,
        options=["Goblinlerle yüzleş", "Kılıç ara", "Devriye askerlerinden sakın", "Geri dön"],
    ...
    "goblinler": Question(
        ...
        answer_id=0,
        options=["Saldır", "Savun ve geri püskürt", "İksiri kullan", "Kaç"],
    ...
    "kilic_bul": Question(
        ...
        answer_id=0,
        options=["Kale yoluna çık", "Başlangıca dön"],
    ...
    "asker_devriyesi": Question(
        ...
        answer_id=0,
        options=["Kale yoluna sız", "Başlangıca dön"],
        next_questions=["kale_yolu", "start"]
    ),
    ...
    "bataklik": Question(
        ...
        answer_id=0,
        options=["Yılanla karşılaş", "Kalkan ara", "Geri dön"],
    ...
    "yilan": Question(
        ...
        answer_id=0,
        options=["Saldır", "Savun", "İksiri kullan"],
    ...
    "kale_yolu": Question(
        ...
        answer_id=0,
        options=["Zindana sız", "Kuyudan dolaş", "Doğrudan kaleye yaklaş", "Geri dön"],
    ...
    "zindan_girisi": Question(
        ...
        answer_id=0,
        options=["Goblin bekçileri atlat", "Zombi geçidinden sız", "Geri dön"],
    ...
    "zindan_ic": Question(
        ...
        answer_id=0,
        options=["Labirente gir"],
        next_questions=["labirent_1"],
        reward="Labirent Haritası"
    ),
    ...
    "labirent_2": Question(
        ...
        answer_id=0,
        options=["İleri", "Geri dön ve diğer yolu dene"],
